...
public class QUser extends EntityPathBase<User> {
    ...
    public final EnumPath<Role> role = createEnum("role", com.housekeeping.entity.enums.Role.class);
    ...
    public final DateTimePath<LocalDateTime> userEnrollment = createDateTime("userEnrollment", java.time.LocalDateTime.class);
