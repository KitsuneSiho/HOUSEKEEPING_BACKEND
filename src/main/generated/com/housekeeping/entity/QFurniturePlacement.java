...
public class QFurniturePlacement extends EntityPathBase<FurniturePlacement> {
    ...
    public final NumberPath<Double> placementAngle = createNumber("placementAngle", Double.class);
    ...
    public final NumberPath<Double> placementSize = createNumber("placementSize", Double.class);
