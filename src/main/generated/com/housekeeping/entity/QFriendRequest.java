...
public class QFriendRequest extends EntityPathBase<FriendRequest> {
    ...
    public final QUser requestReceiver;

    public final QUser requestSender;
    ...
    public QFriendRequest(Class<? extends FriendRequest> type, PathMetadata metadata, PathInits inits) {
        ...
        this.requestReceiver = inits.isInitialized("requestReceiver") ? new QUser(forProperty("requestReceiver"), inits.get("requestReceiver")) : null;
        this.requestSender = inits.isInitialized("requestSender") ? new QUser(forProperty("requestSender"), inits.get("requestSender")) : null;
    }
