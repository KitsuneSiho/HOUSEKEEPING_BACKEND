...
public class QFriend extends EntityPathBase<Friend> {
    ...
    public final QUser friendUser1;

    public final QUser friendUser2;
    ...
    public QFriend(Class<? extends Friend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.friendUser1 = inits.isInitialized("friendUser1") ? new QUser(forProperty("friendUser1"), inits.get("friendUser1")) : null;
        this.friendUser2 = inits.isInitialized("friendUser2") ? new QUser(forProperty("friendUser2"), inits.get("friendUser2")) : null;
    }
